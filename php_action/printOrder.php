...
<table align="center" cellpadding="0" cellspacing="0" style="width: 100%;border:1px solid black;margin-bottom: 10px;">
               <tbody>
                  ...
                  <tr>
                     <td colspan="3" style=" text-align: right;">Pharma Vault</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">Kathmandu, Nepal</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">Tele: 1234567890,1478523690.</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">Email: email@email.co.np</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;color: blue;text-decoration: underline;">email@email.co.np</td>
                  </tr>
                  <tr>
            ...
            $x++;
                ...
                $table.= '
                  ...
                  <tr>
                     ...
                     <td rowspan="2" colspan="2" style="vertical-align: bottom;padding: 5px;color: red;border-right: 1px solid black;text-align: center;">for Pharma Vault</td>
                  </tr>
                  <tr>
